...
public class DeviceListAcitivity extends Activity {
    ...
    private void permissionChecking(){
        ...
        if (CURRENT_ANDROID_VERSION >= Build.VERSION_CODES.M) { //Marshmallow
            ...
            if (ContextCompat.checkSelfPermission(DeviceListAcitivity.this, Manifest.permission.ACCESS_COARSE_LOCATION)
                ...
                if (ActivityCompat.shouldShowRequestPermissionRationale(DeviceListAcitivity.this,
                    ...
                    alertDialogBuilder
                            ...
                            .setPositiveButton("Allow",new DialogInterface.OnClickListener() {
                                public void onClick(DialogInterface dialog,int id) {
                                    ActivityCompat.requestPermissions(DeviceListAcitivity.this,
        ...
        switch (requestCode) {
            case PERMISSIONS_REQUEST_LOCATION: {
                ...
                if (grantResults.length > 0
                    ...
                    Toast.makeText(DeviceListAcitivity.this,"Permission is Denied!",Toast.LENGTH_LONG).show();
                }
                return;
            }
